...
def figMetaData(file_path):
    ...
    print(f"{dir(img_doc)}\n")
    decimalLong = convertGPScoordinate(img_doc.gps_longitude, img_doc.gps_longitude_ref)
    decimalLat = convertGPScoordinate(img_doc.gps_latitude, img_doc.gps_latitude_ref)
